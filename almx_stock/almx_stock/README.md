...
Este módulo personalizado para Odoo 13 y Odoo 16 extiende y modifica el módulo `stock.picking` para agregar funcionalidades personalizadas, campos adicionales y vistas mejoradas.

## Características Principales

- **Campos Personalizado en Transferencias:** Agrega campos personalizados al formulario de orden de venta (`stock.picking`).
...
1. Clona este repositorio en tu instancia de Odoo:
    ...
    ```bash
    git clone https://github.com/alamex-mx/almx_stock.git
    ```
